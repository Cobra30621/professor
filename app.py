...
#特殊能力
    ...
    if re.search('特殊能力', event.message.text, re.IGNORECASE):
        ...
        link = ['https://upload.cc/i1/2018/11/23/lhXGLv.png','https://www.youtube.com/watch?v=pXNms9UxV9k','https://home.gamer.com.tw/creation.php?owner=s10530032']
...
#推薦課程與展覽
    ...
    if re.search('推薦課程與展覽', event.message.text, re.IGNORECASE):
        ...
        image = ['https://upload.cc/i1/2018/11/23/GATLzw.png','https://upload.cc/i1/2018/11/23/YCVQqc.png','https://upload.cc/i1/2018/11/23/o0Qs5y.png']
